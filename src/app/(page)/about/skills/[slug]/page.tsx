...
export default function SkillSlugPage() {
  ...
  return (
    <div className="w-full flex flex-col h-[calc(100vh-56px)] bg-white dark:bg-gray-900 overflow-hidden">
      <div className="shrink-0 flex items-center justify-between px-6 py-2.75 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-3">
          <span className="text-gray-900 dark:text-white">
            {CATEGORY_ICONS[categoryLabel] ?? (
              <Layers className="w-10 h-10 font-bold" />
            )}
          </span>
          <div>
                ...
                <table className="min-w-full">
                  <thead>
                    <tr className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900">
                      ...
                      <th
                        className={`${thBase} ${sortKey === "projects" ? thActive : thInactive}`}
                      ...
                      <th
                        className={`${thBase} ${sortKey === "experience" ? thActive : thInactive}`}
                      ...
                      <th
                        className={`${thBase} ${sortKey === "proficiency" ? thActive : thInactive}`}
