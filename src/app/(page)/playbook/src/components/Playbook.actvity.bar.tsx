...
const navItems = [
  { icon: BookOpen, label: "Tutorials", href: "/about/tutorials" },
  { icon: Clapperboard, label: "Product Showcase", href: "/about/showcase" },
  { icon: Video, label: "Short Videos", href: "/about/shorts" },
  { icon: Tv2, label: "Vlogs", href: "/about/vlogs" },
  { icon: Cpu, label: "Tech Content", href: "/about/tech" },
  { icon: GraduationCap, label: "How To Use", href: "/about/how-to-use" },
  { icon: Heart, label: "Favorites", href: "/playbook/favorites" },
  { icon: Eye, label: "Watch List", href: "/playbook/watch-list" },
];

export default function PlayBookActivityBar() {
